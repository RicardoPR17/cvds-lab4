        ...
        private void setup() {
                ...
                functionController = new FunctionController(
                                ...
                                new FunctionModel(Color.BLACK, language.getFunctionControllerNames()[0],
                                                language.getFunctionControllerNames()[1],
                                                language.getFunctionControllerNames()[2]),
                                mainFrameController);
                ...
                creditsController = new CreditsController(
                                new CreditsPanel(),
                                new CreditsModel(language.getFunctionControllerNames()[2], CONTRIBUTORS, Color.BLACK,
                                                language),
                                mainFrameController);
                ...
                highScoreController = new HighScoreController(
                                new HighScorePanel(),
                                new HighScoreModel(language.getFunctionControllerNames()[1], SCORE_NUMBER, Color.BLACK,
                                                language),
                                mainFrameController);
